...
Original file is located at
    https://colab.research.google.com/drive/1XmVg_5NjRHWE0_vPTA_hFZ8Xb4yEhDup
"""
...
def extract_pdf_text_from_bytes(pdf_bytes: bytes) -> str:
    """Safely write bytes to a temp PDF and extract text for Q&A context."""
...
if st.session_state.report_bytes:
    ...
    if question:
        if not txt.strip():
            ...
            # If an OpenAI key exists, use AI (RAG-lite). Otherwise, fallback to simple keyword search
            if OPENAI_KEY:
                try:
                    ...
                    with st.spinner("Thinking with AI... 🤖"):
                        resp = client.chat.completions.create(
                            ...
                            messages=[
                                {"role": "system", "content":
                                    "You are a helpful cybersecurity analyst. Answer based ONLY on the report content. "
                ...
                # Fallback: simple keyword-based best paragraph
